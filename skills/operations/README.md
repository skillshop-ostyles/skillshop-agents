...
|--|--|--|--|
| [timebomb-scanner](../operations/timebomb-scanner/) | /timebomb | Senior | Find hardcoded dates, expiring assumptions, and rotting workarounds - things that will break silently when the clock runs out. |
