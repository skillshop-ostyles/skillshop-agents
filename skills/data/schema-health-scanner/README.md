# Schema Health Scanner - /schema-health
...
cp -r skill-shop-agents/skills/data/schema-health-scanner ~/.claude/skills/
```

## Audience

Both - seniors use it as pre-migration health check and code review input; vibe-coders learn structural schema hygiene they never had to think about.
