...
| [performance-anti-pattern-detector](../quality/performance-anti-pattern-detector/) | /perf | Senior | Detects 8 performance anti-patterns: N+1 queries, sync-over-async, hot-loop allocation, listener leaks, string concat in loops, unnecessary serialization, large closure captures, redundant computation in loops. |
